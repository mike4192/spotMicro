...
silent only
silent tabonly
cd ~/catkin_ws/src/spot_micro_walk/src/spot_micro_walk
...
exe '4resize ' . ((&lines * 8 + 30) / 60)
exe 'vert 4resize ' . ((&columns * 55 + 83) / 166)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
if bufexists("pupper_src/SwingLegController.py") | buffer pupper_src/SwingLegController.py | else | edit pupper_src/SwingLegController.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("pupper_src/Command.py") | buffer pupper_src/Command.py | else | edit pupper_src/Command.py | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 4resize ' . ((&columns * 55 + 83) / 166)
tabnext 1
badd +235 run_robot.py
badd +198 pupper/Config.py
badd +4 pupper_src/Controller.py
badd +27 pupper_src/State.py
badd +11 pupper_src/Command.py
badd +1 pupper_src/Gaits.py
badd +50 pupper_src/StanceController.py
badd +1 spot_micro_kinematics/utilities/transformations.py
badd +1 pupper_src/SwingLegController.py
